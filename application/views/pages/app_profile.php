 					...
 					<div class="profile-head">
 						...
 						<div class="profile-info">
 							<div class="profile-photo">
 								<img src="<?php echo ASSETS; ?>images/profile/profile.png" class="img-fluid rounded-circle" alt="">
 							</div>
 				...
 				<div class="card">
 					<div class="card-body">
 						...
 						<div class="profile-blog mb-5">
 							...
 							<img src="<?php echo ASSETS; ?>images/profile/1.jpg" alt="" class="img-fluid mt-4 mb-4 w-100">
 							...
 							<div class="row mt-4">
 								<div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
 									<a href="javascript:void()" class="interest-cat">
 										<img src="<?php echo ASSETS; ?>images/profile/2.jpg" alt="" class="img-fluid">
 										<p>Shopping Mall</p>
 									</a>
 								</div>
 								<div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
 									<a href="javascript:void()" class="interest-cat">
 										<img src="<?php echo ASSETS; ?>images/profile/3.jpg" alt="" class="img-fluid">
 										<p>Photography</p>
 									</a>
 								</div>
 								<div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
 									<a href="javascript:void()" class="interest-cat">
 										<img src="<?php echo ASSETS; ?>images/profile/4.jpg" alt="" class="img-fluid">
 										<p>Art &amp; Gallery</p>
 									</a>
 								</div>
 								<div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
 						...
 						<div class="profile-news">
 							...
 							<div class="media pt-3 pb-3">
 								<img src="<?php echo ASSETS; ?>images/profile/5.jpg" alt="image" class="mr-3 rounded" width="75">
 							...
 							<div class="media pt-3 pb-3">
 								<img src="<?php echo ASSETS; ?>images/profile/6.jpg" alt="image" class="mr-3 rounded" width="75">
 								<div class="media-body">
 									<h5 class="m-b-5">Collection of textile samples</h5>
 									<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
 								</div>
 							...
 							<div class="media pt-3 pb-3">
 								<img src="<?php echo ASSETS; ?>images/profile/7.jpg" alt="image" class="mr-3 rounded" width="75">
 								<div class="media-body">
 									<h5 class="m-b-5">Collection of textile samples</h5>
 									<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
 								</div>
 									...
 									<div id="my-posts" class="tab-pane fade active show">
 										<div class="my-post-content pt-3">
 											...
 											<div class="profile-uoloaded-post border-bottom-1 pb-5">
 												<img src="<?php echo ASSETS; ?>images/profile/8.jpg" alt="" class="img-fluid">
 											...
 											<div class="profile-uoloaded-post border-bottom-1 pb-5">
 												<img src="<?php echo ASSETS; ?>images/profile/9.jpg" alt="" class="img-fluid">
 												<a class="post-title" href="javascript:void()">
 													<h4>Collection of textile samples lay spread</h4>
 												</a>
 												<p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
