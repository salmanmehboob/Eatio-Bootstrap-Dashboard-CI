					...
					<div class="col-xl-12 col-lg-6 ">
						<div class="card h-auto">
							<div class="card-body text-center">
								<img src="<?php echo ASSETS; ?>images/avatar/1.jpg" width="150" class="rounded-circle mb-4" alt="" />
							...
							<div class="card bg-secondary sticky mb-0">
								...
								<div class="card-footer border-0 py-4 bg-warning rounded-xl">
									<div class="media align-items-center">
										<img class="mr-3 img-fluid rounded-circle" width="50" src="<?php echo ASSETS; ?>images/delivery.png" alt="DexignZone">
								...
								<div class="table-responsive ">
									<table class="table items-table">
										...
										<tr>
											<td>
												<div class="media">
													<img class="mr-3 img-fluid rounded" width="85" src="<?php echo ASSETS; ?>images/avatar/1.jpg" alt="DexignZone">
													<div class="media-body">
										...
										<tr>
											<td>
												<div class="media">
													<img class="mr-3 img-fluid rounded" width="85" src="<?php echo ASSETS; ?>images/avatar/2.jpg" alt="DexignZone">
													<div class="media-body">
														<small class="mt-0 mb-1 text-primary font-w500">MAIN COURSE</small>
										...
										<tr>
											<td>
												<div class="media">
													<img class="mr-3 img-fluid rounded" width="85" src="<?php echo ASSETS; ?>images/avatar/3.jpg" alt="DexignZone">
													<div class="media-body">
														<small class="mt-0 mb-1 text-primary font-w500">MAIN COURSE</small>
						...
						<div class="card">
							<div class="card-body">
								<div class="full-map-area mb-4">
									<img src="<?php echo ASSETS; ?>images/map-2.png" alt="">
								...
								<div class="row mx-0">
									<div class="media align-items-center col-md-4 col-lg-6 px-0 mb-3 mb-md-0">
										<img class="mr-3 img-fluid rounded-circle" width="65" src="<?php echo ASSETS; ?>images/avatar/3.jpg" alt="DexignZone">
										<div class="media-body">
