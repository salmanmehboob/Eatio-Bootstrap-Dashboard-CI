						...
						<div class="card">
							...
							<div class="card-body revenue-chart px-3">
								<div class="d-flex align-items-end pl-3">
									<div class="mr-4">
										<h3 class="font-w600 mb-0"><img src="<?php echo ASSETS; ?>images/svg/ic_stat3.svg" height="22" width="22" class="mr-2 mb-1" alt="" />
											<span class="counter">257</span>k
										</h3>
										<small class="text-dark fs-14">Total Sales</small>
									</div>
									<div>
										<h3 class="font-w600 mb-0"><img src="<?php echo ASSETS; ?>images/svg/ic_stat3.svg" height="22" width="22" class="mr-2 mb-1" alt="" /><span class="counter">1,245</span></h3>
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header border-0 pb-0 d-sm-flex d-block">
								...
								<div class="card-action card-tabs">
									<ul class="nav nav-tabs" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#monthly1" role="tab">
												Monthly
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="#weekly1" role="tab">
												Weekly
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="#today1" role="tab">
												Today
											</a>
										</li>
									</ul>
									...
									<div class="row">
										<div class="col-md-4 col-xl-4 col-xxl-6 col-sm-6 mb-5">
											<div class="media mb-4">
												<img src="<?php echo ASSETS; ?>images/dish/pic5.jpg" style="width:100%;" class="rounded" alt="" />
											</div>
											<div class="info">
												...
												<a href="#" class="btn btn-primary light btn-sm btn-rounded px-4"><i class="fa fa-heart-o mr-2 scale5 "></i> <strong>256k</strong> Like it</a>
											</div>
										</div>
										<div class="col-md-4 col-xl-4 col-xxl-6 col-sm-6 mb-5">
											<div class="media mb-4">
												<img src="<?php echo ASSETS; ?>images/dish/pic4.jpg" style="width:100%;" class="rounded" alt="" />
											</div>
											<div class="info">
												<h5 class="text-black mb-3">Medium Spicy Pizza with Kemangi Leaf</h5>
												<div class="star-review fs-14 mb-3">
										...
										<div class="col-md-4 col-xl-4 col-xxl-6 col-sm-6 mb-5">
											<div class="media mb-4">
												<img src="<?php echo ASSETS; ?>images/dish/pic3.jpg" style="width:100%;" class="rounded" alt="" />
											</div>
											<div class="info">
												<h5 class="text-black mb-3">Medium Spicy Pizza with Kemangi Leaf</h5>
												<div class="star-review fs-14 mb-3">
										...
										<div class="col-md-4 col-xl-4 col-xxl-6 col-sm-6 mb-5">
											<div class="media mb-4">
												<img src="<?php echo ASSETS; ?>images/dish/pic2.jpg" style="width:100%;" class="rounded" alt="" />
											</div>
											<div class="info">
												<h5 class="text-black mb-3">Medium Spicy Pizza with Kemangi Leaf</h5>
												<div class="star-review fs-14 mb-3">
										...
										<div class="col-md-4 col-xl-4 col-xxl-6 col-sm-6 mb-5">
											<div class="media mb-4">
												<img src="<?php echo ASSETS; ?>images/dish/pic1.jpg" style="width:100%;" class="rounded" alt="" />
											</div>
											<div class="info">
												<h5 class="text-black mb-3">Medium Spicy Pizza with Kemangi Leaf</h5>
												<div class="star-review fs-14 mb-3">
							...
							<div class="card-footer border-0 pt-0 text-center">
								<a href="#" class="btn-link">View more <i class="fa fa-angle-down ml-2 scale-2"></i></a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="card">
							...
							<div class="card-body p-0 pt-3">
								<div class="media items-list-1">
									...
									<img class="img-fluid rounded mr-3" width="85" src="<?php echo ASSETS; ?>images/dish/pic1.jpg" alt="DexignZone">
									<div class="media-body col-sm-4 col-6 col-xxl-6 px-0">
										<h5 class="mt-0 mb-3 text-black">Tuna soup spinach with himalaya salt</h5>
										<small class="text-primary font-w500"><strong class="text-secondary mr-2">$12.56</strong> MAIN COURSE</small>
									</div>
								...
								<div class="media items-list-1">
									...
									<img class="img-fluid rounded mr-3" width="85" src="<?php echo ASSETS; ?>images/dish/pic2.jpg" alt="DexignZone">
									<div class="media-body col-sm-4 col-6 col-xxl-6 px-0">
										<h5 class="mt-0 mb-3 text-black">Tuna soup spinach with himalaya salt</h5>
										<small class="text-primary font-w500"><strong class="text-secondary mr-2">$12.56</strong> MAIN COURSE</small>
									</div>
								...
								<div class="media items-list-1">
									...
									<img class="img-fluid rounded mr-3" width="85" src="<?php echo ASSETS; ?>images/dish/pic3.jpg" alt="DexignZone">
									<div class="media-body col-sm-4 col-6 col-xxl-6 px-0">
								...
								<div class="media items-list-1">
									...
									<img class="img-fluid rounded mr-3" width="85" src="<?php echo ASSETS; ?>images/dish/pic4.jpg" alt="DexignZone">
									<div class="media-body col-sm-4 col-6 col-xxl-6 px-0">
										<h5 class="mt-0 mb-3 text-black">Watermelon juice with ice</h5>
										<small class="text-primary font-w500"><strong class="text-secondary mr-2">$12.56</strong> MAIN COURSE</small>
									</div>
									<div class="media-footer ml-auto col-3 px-0 d-flex align-self-center align-items-center">
										<div class="mr-3">
								...
								<div class="media items-list-1">
									...
									<img class="img-fluid rounded mr-3" width="85" src="<?php echo ASSETS; ?>images/dish/pic5.jpg" alt="DexignZone">
									<div class="media-body col-sm-4 col-6 col-xxl-6 px-0">
										<h5 class="mt-0 mb-3 text-black">Tuna soup spinach with himalaya salt</h5>
										<small class="text-primary font-w500"><strong class="text-secondary mr-2">$12.56</strong> MAIN COURSE</small>
									</div>
								...
								<div class="tab-pane fade show active" id="monthly">
									<div class="media mb-4 items-list-2">
										...
										<div class="media-body col-6 px-0">
											...
											<small class="text-primary font-w500 mb-3">SPAGETHI</small>
									...
									<div class="media mb-4 items-list-2">
										<img class="img-fluid rounded mr-3" width="85" src="<?php echo ASSETS; ?>images/dish/pic4.jpg" alt="DexignZone">
										<div class="media-body col-6 px-0">
											<h5 class="mt-0 mb-1 text-black">Pizza Meal for Kids (Small size)</h5>
