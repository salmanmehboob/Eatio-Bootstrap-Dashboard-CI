  							...
  							<table class="table table-sm mb-0">
  								...
  								<tbody id="orders">
  									<tr class="btn-reveal-trigger">
  										...
  										<td class="py-2 text-right"><span class="badge badge-success">Completed<span class="ml-1 fa fa-check"></span></span>
  										</td>
  									...
  									<tr class="btn-reveal-trigger">
  										...
  										<td class="py-2 text-right"><span class="badge badge-primary">Processing<span class="ml-1 fa fa-redo"></span></span>
  										</td>
  									...
  									<tr class="btn-reveal-trigger">
  										...
  										<td class="py-2 text-right"><span class="badge badge-warning">Pending<span class="ml-1 fas fa-stream"></span></span>
  										</td>
