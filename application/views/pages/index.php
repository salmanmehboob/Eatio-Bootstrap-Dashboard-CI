	...
	<div class="container-fluid">
		...
		<div class="row">
					...
					<div class="card-body revenue-chart px-3">
						<div class="d-flex align-items-end pr-3 pull-right revenue-chart-bar">
							<div class="d-flex align-items-end mr-4">
								<img src="<?php echo ASSETS; ?>images/svg/ic_stat2.svg" height="22" width="22" class="mr-2 mb-1" alt="" />
								<div>
							...
							<div class="d-flex align-items-end">
								<img src="<?php echo ASSETS; ?>images/svg/ic_stat1.svg" height="22" width="22" class="mr-2 mb-1" alt="" />
								<div>
			...
			<div class="col-xl-3 col-xxl-3 col-lg-4 col-md-12">
				<div class="card bg-secondary" style="background-image:url(<?php echo ASSETS; ?>images/bg-icon.png); background-repeat:no-repeat; background-position:top right;">
