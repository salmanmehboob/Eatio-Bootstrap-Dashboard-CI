			...
			<div class="col-md-12">
				<div class="widget-carousel owl-carousel">
					<div class="items">
						<div class="bootstrap-media card p-4">
							<div class="media mb-4 align-items-center">
								<img class="mr-3 img-fluid rounded-xl" width="94" src="<?php echo ASSETS; ?>images/dish/pic1.jpg" alt="DexignZone">
								<div class="media-body">
									<h5 class="mt-0 mb-3 text-black">Tuna soup spinach with himalaya salt</h5>
									<small class="mb-0 text-primary">MAIN COURSE</small>
								</div>
							</div>
							...
							<div class="reviewer-box">
								<div class="media align-items-center">
									<img class="mr-3 img-fluid rounded" width="55" src="<?php echo ASSETS; ?>images/avatar/1.jpg" alt="DexignZone">
									<div class="media-body">
					...
					<div class="items">
						<div class="bootstrap-media card p-4">
							<div class="media mb-4 align-items-center">
								<img class="mr-3 img-fluid rounded-xl" width="94" src="<?php echo ASSETS; ?>images/dish/pic2.jpg" alt="DexignZone">
								<div class="media-body">
									<h5 class="mt-0 mb-3 text-black">Chicken curry special with cucumber</h5>
									<small class="mb-0 text-primary">MAIN COURSE</small>
								</div>
							</div>
							...
							<div class="reviewer-box">
								<div class="media align-items-center">
									<img class="mr-3 img-fluid rounded" width="55" src="<?php echo ASSETS; ?>images/avatar/2.jpg" alt="DexignZone">
									<div class="media-body">
					...
					<div class="items">
						<div class="bootstrap-media card p-4">
							<div class="media mb-4 align-items-center">
								<img class="mr-3 img-fluid rounded-xl" width="94" src="<?php echo ASSETS; ?>images/dish/pic3.jpg" alt="DexignZone">
								<div class="media-body">
									<h5 class="mt-0 mb-3 text-black">Tuna soup spinach with himalaya salt</h5>
									<small class="mb-0 text-primary">MAIN COURSE</small>
								</div>
							...
							<div class="reviewer-box">
								<div class="media align-items-center">
									<img class="mr-3 img-fluid rounded" width="55" src="<?php echo ASSETS; ?>images/avatar/3.jpg" alt="DexignZone">
									<div class="media-body">
					...
					<div class="items">
						<div class="bootstrap-media card p-4">
							<div class="media mb-4 align-items-center">
								<img class="mr-3 img-fluid rounded-xl" width="94" src="<?php echo ASSETS; ?>images/dish/pic4.jpg" alt="DexignZone">
								<div class="media-body">
									<h5 class="mt-0 mb-3 text-black">Meidum Spicy Spagethi Italiano</h5>
									<small class="mb-0 text-primary">MAIN COURSE</small>
								</div>
							</div>
							<p class="fs-18 text-black mb-4">A very fine addition to the not over plentiful supply of good restaurants in this part of west London.</p>
							<div class="reviewer-box">
								<div class="media align-items-center">
									<img class="mr-3 img-fluid rounded" width="55" src="<?php echo ASSETS; ?>images/avatar/4.jpg" alt="DexignZone">
									<div class="media-body">
					...
					<div class="items">
						<div class="bootstrap-media card p-4">
							<div class="media mb-4 align-items-center">
								<img class="mr-3 img-fluid rounded-xl" width="94" src="<?php echo ASSETS; ?>images/dish/pic5.jpg" alt="DexignZone">
								<div class="media-body">
									<h5 class="mt-0 mb-3 text-black">Tuna soup spinach with himalaya salt</h5>
									<small class="mb-0 text-primary">MAIN COURSE</small>
								</div>
							...
							<div class="reviewer-box">
								<div class="media align-items-center">
									<img class="mr-3 img-fluid rounded" width="55" src="<?php echo ASSETS; ?>images/avatar/5.jpg" alt="DexignZone">
									<div class="media-body">
										<h4 class="mt-0 mb-1 text-white">Roberto Jr.</h4>
										<small class="mb-0 text-light">Head Marketing</small>
									</div>
				...
				<div class="card">
					...
					<div class="card-body p-0">
						<div class="media review-box">
							<img class="mr-3 img-fluid btn-rounded" width="55" src="<?php echo ASSETS; ?>images/avatar/1.jpg" alt="DexignZone">
							<div class="media-body">
						...
						<div class="media review-box">
							<img class="mr-3 img-fluid btn-rounded" width="55" src="<?php echo ASSETS; ?>images/avatar/2.jpg" alt="DexignZone">
							<div class="media-body">
						...
						<div class="media review-box">
							<img class="mr-3 img-fluid btn-rounded" width="55" src="<?php echo ASSETS; ?>images/avatar/3.jpg" alt="DexignZone">
							<div class="media-body">
						...
						<div class="media review-box">
							<img class="mr-3 img-fluid btn-rounded" width="55" src="<?php echo ASSETS; ?>images/avatar/4.jpg" alt="DexignZone">
							<div class="media-body">
						...
						<div class="media review-box">
							<img class="mr-3 img-fluid btn-rounded" width="55" src="<?php echo ASSETS; ?>images/avatar/5.jpg" alt="DexignZone">
							<div class="media-body">
								<h4 class="mt-0 mb-0 text-black">Samuel Hawkins</h4>
								<ul class="review-meta mb-3 d-block d-sm-flex align-items-center">
									<li class="mr-3"><small>Head Marketing</small></li>
					...
					<div class="card-footer border-0 text-center py-4">
						<a href="#" class="btn btn-primary">Read More <i class="fa fa-angle-double-down scale2 ml-2"></i></a>
					</div>
				</div>
			</div>
					...
					<div class="card-body">
						<div class="testimonial-one owl-carousel">
							<div class="items">
								<div class="text-white">
									<div class="media align-items-center mb-3">
										<img class="mr-3 img-fluid rounded-circle" width="50" src="<?php echo ASSETS; ?>images/avatar/1.jpg" alt="DexignZone">
										<div class="media-body">
							...
							<div class="items">
								<div class="text-white">
									<div class="media align-items-center mb-3">
										<img class="mr-3 img-fluid rounded-circle" width="50" src="<?php echo ASSETS; ?>images/avatar/2.jpg" alt="DexignZone">
										<div class="media-body">
											<h4 class="mt-0 mb-1 text-white">James Kowalski</h4>
											<small class="mb-0 text-light">Head Marketing</small>
										</div>
